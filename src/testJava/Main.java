...
public class Main {
	...
	static public void Menu() {
		...
		System.out.println("PREMI: [6] Per mostrare l'immagine");
		System.out.println("PREMI: [7] Per alzare la luminosità dell'immagine");
		System.out.println("PREMI: [8] Per abbassare la luminosità dell'immagine");
		System.out.println("...............................");
	...
	static public void CheckInputMenu(String value) {
		switch (value) {
			...
			case "8":
				...
				listImg[0].abbassaLuminosita(Integer.parseInt(input4));
